...
Profiles are **server-enforced**, configured by the server administrator in the DataSHIELD settings. The researcher cannot bypass them. The **most restrictive** profile across all servers is adopted by all.
