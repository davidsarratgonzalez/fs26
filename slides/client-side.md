...
<svg viewBox="0 -15 720 355" style="width: 100%; max-height: 430px;">
  ...
  <g v-click>
    <rect x="195" y="258" width="330" height="28" rx="5" fill="rgba(102,221,170,0.06)" stroke="rgba(102,221,170,0.15)" stroke-width="0.6"/>
    <text x="360" y="270" text-anchor="middle" fill="#66ddaa" font-family="Roboto Mono" font-size="2.2">App authenticity</text>
    <text x="360" y="281" text-anchor="middle" fill="#b0b8c0" font-family="Roboto Mono" font-size="2">SHA-256 verified against all servers before execution</text>
  </g>
