...
<svg viewBox="0 0 780 340" style="width: 100%; max-height: 390px;">
  ...
  <text x="720" y="52" fill="#88ccff" font-family="Roboto Mono" font-size="3.5" text-anchor="middle">Local Training</text>
  <text x="720" y="64" fill="#b0b8c0" font-family="Roboto Mono" font-size="2.5" text-anchor="middle">+</text>
  <text x="720" y="76" fill="#b0b8c0" font-family="Roboto Mono" font-size="2.5" text-anchor="middle">Privacy Controls</text>
  ...
  <text x="470" y="290" fill="#b0b8c0" font-family="Roboto Mono" font-size="2.5">FedAvg · FedProx · FedAdam</text>
  ...
  <!-- Labels -->
  <text fill="#FFD000" font-family="Roboto Mono" font-size="3.5" text-anchor="middle"><textPath href="#flQL" startOffset="50%">global model</textPath></text>
  <text fill="#66ddaa" font-family="Roboto Mono" font-size="2.8" text-anchor="middle"><textPath href="#flRL" startOffset="50%">weight updates</textPath></text>
  <text fill="#FFD000" font-family="Roboto Mono" font-size="3.5" text-anchor="middle"><textPath href="#flQR" startOffset="50%">global model</textPath></text>
  <text fill="#66ddaa" font-family="Roboto Mono" font-size="2.8" text-anchor="middle"><textPath href="#flRR" startOffset="50%">weight updates</textPath></text>
